    ...
    >
      ...
      >
        ...
        <div className="px-6 pt-6 pb-4 flex items-start justify-between">
          <h2 className="text-lg font-bold atelier-text-90">{title}</h2>
          <button
            onClick={() => onClose()}
            disabled={isLoading}
            className="p-1 -mr-1 atelier-text-30 hover:atelier-text-75 transition-colors disabled:opacity-50"
          >
        ...
        <div className="px-6 pb-4">
          <p className="text-sm atelier-text-50 leading-relaxed">{message}</p>
        ...
        <div className="px-6 pb-6 flex justify-end gap-3">
          <button
            onClick={() => onClose()}
            disabled={isLoading}
            className="h-9 px-4 text-sm atelier-text-50 hover:atelier-text-75 transition-colors disabled:opacity-50 rounded-lg"
          >
            {m.common_cancel()}
          </button>
          <button
...
export default function AtelierConfirmationModal(
