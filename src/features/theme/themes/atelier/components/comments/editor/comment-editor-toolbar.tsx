...
const ToolbarButton: React.FC<ToolbarButtonProps> = ({
  ...
  <button
    ...
    className={cn(
      ...
      isActive
        ? "bg-(--atelier-primary) text-white dark:text-black/75"
        : "atelier-text-50 hover:bg-black/5 dark:hover:bg-white/10 hover:atelier-text-75",
    )}
    title={label}
    type="button"
  >
...
const AtelierCommentEditorToolbar: React.FC<CommentEditorToolbarProps> = ({
  editor,
  onLinkClick,
  onImageClick,
}) => {
...
export default AtelierCommentEditorToolbar;
