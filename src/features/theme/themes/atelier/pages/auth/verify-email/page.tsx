  ...
  return (
    <div className="flex flex-col gap-8">
      ...
      <div className="flex flex-col items-center justify-center p-4">
        {status === "ANALYZING" && (
          <div className="flex items-center gap-3 text-(--atelier-primary) animate-in fade-in duration-500 py-8">
        ...
        {status === "ERROR" && (
          <div className="flex flex-col items-center justify-center text-center space-y-8 animate-in fade-in zoom-in-95 duration-500 w-full py-4">
            ...
            <p className="text-sm font-medium atelier-text-50 leading-relaxed max-w-xs mx-auto text-red-600 dark:text-red-400">
              {error === "invalid_token"
            ...
            <div className="space-y-4 w-full flex flex-col pt-4">
              <Link
                to="/login"
                className="w-full py-3.5 rounded-xl atelier-btn-primary font-bold text-sm transition-all active:scale-[0.98]"
              >
                {m.verify_email_error_action()}
              </Link>
              <Link
                to="/login"
                className="text-xs font-medium text-(--atelier-primary) hover:underline"
              >
